    ...
    <div className="min-h-screen flex" style={{ background: 'var(--ivory)' }}>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="lg:hidden text-center mb-8"><Image src="/images/logo.png" alt="SKSS" width={60} height={60} className="mx-auto mb-3 object-contain" /><p style={{ fontFamily: 'var(--font-heading)', fontSize: 20 }}>Sai Krishna Silks</p></div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div><label className="text-xs mb-1 block" style={{ color: 'var(--text-secondary)' }}>Password</label>
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} className="input-base pr-10" value={password} onChange={e => setPassword(e.target.value)} required />
