  ...
  return (
    <div className="page-container py-16 max-w-3xl">
      ...
      <div className="space-y-6 text-sm" style={{ color: 'var(--text-secondary)' }}>
        ...
        <div><h3 className="font-semibold text-base mb-2" style={{ fontFamily: 'var(--font-heading)', color: 'var(--text-primary)' }}>Packaging</h3><p>All sarees are carefully folded, wrapped in tissue, and packed in our signature SKSS packaging to preserve the fabric during transit.</p></div>
      </div>
    </div>
  )
}
